...
class NonogramLogicOperationsTest {
    ...
    @Test
    @DisplayName("o06005-TRTC")
    void shouldFillTrivialRowsAndColumns() {
        // given
        List<List<String>> expectedBoard = NonogramBoards.expectedNonogramBoardTRTC;
        ...
        // then
        assertThat(o06005_difficulty_1.getLogs()).hasSize(7)
                .containsExactly(
                        "ROW 7 is trivial - filling whole",
                        "ROW 7 - seqNo = 0 excluded",
                        "COLUMN 2 is trivial - filling whole",
                        "COLUMN 2 - seqNo = 0 excluded",
                        "COLUMN 2 - seqNo = 1 excluded",
                        "COLUMN 6 is trivial - filling whole",
                        "COLUMN 6 - seqNo = 0 excluded"
                );
        assertThat(o06005_difficulty_1.getNonogramSolutionBoard()).isEqualTo(expectedBoard);
    }

    @Test
    @DisplayName("o06005-TRTC+3")
    void shouldFillOverlappingFieldsInRows() {
        // given
        List<List<String>> expectedBoard = NonogramBoards.expectedNonogramBoardTRTC_3;
        ...
        for(int rowIdx : IntStream.rangeClosed(0, o06005_difficulty_1.getHeight() - 1).boxed().toList()) {
            o06005_difficulty_1.getNonogramRowLogic().fillOverlappingFieldsInRow(rowIdx);
        }

        // then
        assertThat(o06005_difficulty_1.getLogs()).hasSize(32)
                .containsExactly(
                        "ROW 7 is trivial - filling whole",
                        "ROW 7 - seqNo = 0 excluded",
                        "COLUMN 2 is trivial - filling whole",
                        ...
                        "COLUMN 6 is trivial - filling whole",
                        "COLUMN 6 - seqNo = 0 excluded",
                        "ROW 2, COLUMN 3 - field colouring - fill overlapping fields.",
                        "ROW 2, COLUMN 4 - field colouring - fill overlapping fields.",
                        "ROW 2, COLUMN 5 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 1 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 3 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 4 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 5 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 7 - field colouring - fill overlapping fields.",
                        "ROW 3, COLUMN 8 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 1 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 3 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 4 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 5 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 7 - field colouring - fill overlapping fields.",
                        "ROW 4, COLUMN 8 - field colouring - fill overlapping fields.",
                        "ROW 5, COLUMN 1 - field colouring - fill overlapping fields.",
                        "ROW 5, COLUMN 3 - field colouring - fill overlapping fields.",
                        "ROW 5, COLUMN 4 - field colouring - fill overlapping fields.",
                        "ROW 5, COLUMN 5 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 1 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 3 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 4 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 5 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 7 - field colouring - fill overlapping fields.",
                        "ROW 6, COLUMN 8 - field colouring - fill overlapping fields."
                );
        assertThat(o06005_difficulty_1.getNonogramSolutionBoard()).isEqualTo(expectedBoard);
    }

    @Test
    @DisplayName("o06005-TRTC+12")
    void shouldFillOverlappingFieldsInColumns() {
        // given
        List<List<String>> expectedBoard = NonogramBoards.expectedNonogramBoardTRTC_12;
        ...
        for(int columnIdx : IntStream.rangeClosed(0, o06005_difficulty_1.getWidth() - 1).boxed().toList()) {
            o06005_difficulty_1.getNonogramColumnLogic().fillOverlappingFieldsInColumn(columnIdx);
        }

        // then
        assertThat(o06005_difficulty_1.getLogs()).hasSize(28)
                .containsExactly(
                        "ROW 7 is trivial - filling whole",
                        "ROW 7 - seqNo = 0 excluded",
                        "COLUMN 2 is trivial - filling whole",
                        ...
                        "COLUMN 6 is trivial - filling whole",
                        "COLUMN 6 - seqNo = 0 excluded",
                        "COLUMN 0, ROW 3 - field colouring - fill overlapping fields.",
                        "COLUMN 0, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 0, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 0, ROW 6 - field colouring - fill overlapping fields.",
                        "COLUMN 1, ROW 3 - field colouring - fill overlapping fields.",
                        "COLUMN 1, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 1, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 1, ROW 6 - field colouring - fill overlapping fields.",
                        "COLUMN 3, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 3, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 4, ROW 2 - field colouring - fill overlapping fields.",
                        "COLUMN 4, ROW 3 - field colouring - fill overlapping fields.",
                        "COLUMN 4, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 4, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 4, ROW 6 - field colouring - fill overlapping fields.",
                        "COLUMN 5, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 5, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 8, ROW 3 - field colouring - fill overlapping fields.",
                        "COLUMN 8, ROW 4 - field colouring - fill overlapping fields.",
                        "COLUMN 8, ROW 5 - field colouring - fill overlapping fields.",
                        "COLUMN 8, ROW 6 - field colouring - fill overlapping fields."
                );
        assertThat(o06005_difficulty_1.getNonogramSolutionBoard()).isEqualTo(expectedBoard);
    }

    @Test
    @DisplayName("o06005-TRTC+3+12")
    void shouldFillOverlappingFieldsInRowsAndColumns() {
        // given
        List<List<String>> expectedBoard = NonogramBoards.expectedNonogramBoardTRTC_3_12;
        ...
        // then
        assertThat(o06005_difficulty_1.getLogs()).hasSize(37)
                .containsExactly(
                        "ROW 7 is trivial - filling whole",
                        "ROW 7 - seqNo = 0 excluded",
                        "COLUMN 2 is trivial - filling whole",
