...
public class OverlappingInRow_o07702_Test
    ...
    static Stream<Arguments> provideTestCasesForOverlappingInRow() {
        return Stream.of(
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 1 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 10), List.of(5, 19)),
                        List.of(4, 8),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "O", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 6 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 14), List.of(10, 19)),
                        List.of(9, 4),
                        List.of("-", "-", "-", "-", "-", "-", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 9 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 8), List.of(3, 19)),
                        List.of(2, 10),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 10 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 8), List.of(3, 19)),
                        List.of(2, 10),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o0o07702 / 20x20 / diff 2.0 / Row 11 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 7), List.of(2, 19)),
                        List.of(1, 11),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "O", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o0o07702 / 20x20 / diff 2.0 / Row 12 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 19)),
                        List.of(12),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "O", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 1 #2",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "X", "X", "X", "-", "O", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 7), List.of(11, 19)),
                        List.of(4, 8),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "X", "X", "X", "-", "O", "O", "O", "O", "O", "O", "O", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 2 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "X", "X", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 7), List.of(6, 16), List.of(10, 19)),
                        List.of(5, 2, 2),
                        List.of("-", "-", "-", "O", "O", "-", "-", "-", "X", "X", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 18 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "X", "-", "-", "X", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 7), List.of(6, 17), List.of(9, 19)),
                        List.of(5, 1, 1),
                        List.of("-", "-", "-", "O", "O", "-", "-", "-", "X", "-", "-", "X", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 1 #3",
                        List.of("-", "-", "-", "X", "-", "-", "-", "-", "X", "X", "X", "-", "O", "O", "O", "O", "O", "O", "O", "-"),
                        List.of(List.of(4, 7), List.of(11, 19)),
                        List.of(4, 8),
                        List.of("-", "-", "-", "X", "O", "O", "O", "O", "X", "X", "X", "-", "O", "O", "O", "O", "O", "O", "O", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 6 #2",
                        List.of("-", "-", "-", "O", "-", "-", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 11), List.of(10, 19)),
                        List.of(9, 4),
                        List.of("-", "-", "-", "O", "O", "O", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 10 #2",
                        List.of("-", "-", "-", "-", "-", "-", "O", "O", "O", "-", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 4), List.of(3, 15)),
                        List.of(2, 10),
                        List.of("-", "-", "-", "-", "-", "-", "O", "O", "O", "O", "O", "O", "O", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 18 #2",
                        List.of("-", "-", "-", "O", "O", "-", "-", "X", "X", "-", "-", "X", "-", "-", "-", "-", "-", "-", "-", "-"),
                        List.of(List.of(0, 6), List.of(6, 17), List.of(9, 19)),
                        List.of(5, 1, 1),
                        List.of("-", "-", "O", "O", "O", "-", "-", "X", "X", "-", "-", "X", "-", "-", "-", "-", "-", "-", "-", "-")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 5 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "O"),
                        List.of(List.of(0, 16), List.of(18, 19)),
                        List.of(7, 2),
                        List.of("-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "O", "O")
                ),
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 13 #1",
                        List.of("-", "-", "-", "-", "-", "-", "-", "O", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"),
                ...
                Arguments.of("o07702 / 20x20 / diff 2.0 / Row 3 #1",
