package com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.logic.helpers.solve.mark;
...
import com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.logic.helpers.loggeneration.range.SequenceRangeCorrectionWhenMarkingFieldsLogHelper;
...
import static com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.utils.NonogramHelper.calculateNewMarkedRangeFromParameters;
    ...
    public static void markAvailableFieldsInLine(
        ...
        do {
            ...
            for (int i = 0; i < width; i++) {
                ...
                List<Integer> colouredRange = NonogramHelper.findColouredSequenceRange(solutionBoard, field, isRow, rules);
                ...
                if (matchCount == 1) {
                    String marker = NonogramHelper.indexToSequenceCharMark(matchedIdx);
