...
import static com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.logic.base.NonogramLogic.generateInitialActionsToDo;
...
public class NonogramLogicFactory {
    ...
    public NonogramLogic createFromPayload(NonogramSolvePayload payload) {
        ...
        logic.setActionsToDoList(
                generateInitialActionsToDo(rules)
        );
