package com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.helper.log.exclusion;

import com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.core.logic.NonogramLogic;
import com.puzzlesolverappbackend.puzzleAppFileManager.nonogram.helper.log.loggeneration.LogFormatUtils;
    ...
    public static String convertLogToTestArguments(
        ...
        Arguments.of("%s",
            ...
            List.of(%s)
                ...
                testLabel,
                LogFormatUtils.formatList(stateLine),
