import { 
    ...
    hitoriOptions} from "./types"

export const AddHitoriSortFilter = (filter : sortFilter) => {
    return {
        type: ADD_HITORI_SORT_FILTER,
        payload: {
            filter: filter
        }
    }
...
export const RemoveHitoriSortFilter = (filter : sortFilter) => {
    return {
        type: REMOVE_HITORI_SORT_FILTER,
        payload: {
            filter: filter
        }
    }
...
export const ChangeHitoriSortFilter = (filter : sortFilter) => {
    return {
        type: CHANGE_HITORI_SORT_FILTER,
        payload: {
            filter: filter
        }
    }
...
export const InitOptionsList = (optionsList: hitoriOptions) => {
    return {
