...
export type akariSortFiltersNames = "source" | "difficulty" | "height" | "width" | "area"

export interface akariOptions {
    source : Array<string>,
...
export interface filterTypeDetails {
    filterName: akariSortFiltersNames,
    fontAwesomeIcon: IconDefinition,
    helperText: string
}

export const akariSortFilters : filterTypeDetails[] = [
    {
        filterName: "source",
...
export interface AkariFiltersState {
...
interface AddAkariSortFilter {
    type: typeof ADD_AKARI_SORT_FILTER,
    payload: {
        filter: sortFilter
    }
}

interface RemoveAkariSortFilter {
    type: typeof REMOVE_AKARI_SORT_FILTER,
    payload: {
        filter: sortFilter
    }
}

interface ChangeAkariSortFilter {
    type: typeof CHANGE_AKARI_SORT_FILTER,
    payload: {
        filter: sortFilter
    }
}

export const ADD_AKARI_SORT_FILTER = "ADD_AKARI_SORT_FILTER"
export const REMOVE_AKARI_SORT_FILTER = "REMOVE_AKARI_SORT_FILTER"
export const CHANGE_AKARI_SORT_FILTER = "CHANGE_AKARI_SORT_FILTER"
...
export type AkariFiltersActionTypes = AddAkariSortFilter | RemoveAkariSortFilter | ChangeAkariSortFilter | 
