...
// redux
import { filterTypeDetails,  filterWithDirectionIncludedSelector, selectFilterAction } from "../../../../../store/filters/architect"
import { AppState } from "../../../../../store"
import { Dispatch } from "redux"
import { connect, ConnectedProps, useDispatch} from "react-redux"


interface OwnArchitectSortFilterProps {
    filterDetails : filterTypeDetails,
    priorityIndicator: number
}

const mapStateToProps = (state: AppState, ownProps : OwnArchitectSortFilterProps) => ({

    mode: state.displayReducer.mode,

    ascIncluded: filterWithDirectionIncludedSelector(state.architectFiltersReducer, 
        ownProps.filterDetails.filterName, "ascending"),

    descIncluded: filterWithDirectionIncludedSelector(state.architectFiltersReducer, 
            ownProps.filterDetails.filterName, "descending"),

    arrowUpAction: selectFilterAction(state.architectFiltersReducer, 
        {filterName: ownProps.filterDetails.filterName, sortDirection: "ascending"}),
    
    arrowDownAction: selectFilterAction(state.architectFiltersReducer, 
...
type ArchitectSortFilterPropsFromRedux = ConnectedProps<typeof connector>

type ArchitectSortFilterProps = ArchitectSortFilterPropsFromRedux & OwnArchitectSortFilterProps

const ArchitectSortFilter : React.FC<ArchitectSortFilterProps> = ({filterDetails, arrowUpAction, arrowDownAction,
...
export default connector(ArchitectSortFilter)