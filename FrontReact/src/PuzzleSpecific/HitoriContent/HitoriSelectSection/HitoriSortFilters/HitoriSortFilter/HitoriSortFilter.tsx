...
// redux
import { filterTypeDetails,  filterWithDirectionIncludedSelector, selectFilterAction } from "../../../../../store/filters/hitori"
...
const mapStateToProps = (state: AppState, ownProps : OwnAkariSortFilterProps) => ({
    ...
    ascIncluded: filterWithDirectionIncludedSelector(state.hitoriFiltersReducer, 
        ownProps.filterDetails.filterName, "ascending"),

    descIncluded: filterWithDirectionIncludedSelector(state.hitoriFiltersReducer, 
            ownProps.filterDetails.filterName, "descending"),

    arrowUpAction: selectFilterAction(state.hitoriFiltersReducer, 
        {filterName: ownProps.filterDetails.filterName, sortDirection: "ascending"}),
    
    arrowDownAction: selectFilterAction(state.hitoriFiltersReducer, 
