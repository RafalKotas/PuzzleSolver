...
type HitoriItemCardPropsFromRedux = ConnectedProps<typeof connector>

type HitoriItemCardProps = HitoriItemCardPropsFromRedux & OwnHitoriItemCardProps

const HitoriItemCard : React.FC<HitoriItemCardProps> = ({hitoriDetails, displayMode, SetSelectedHitori, link}) => {
  ...
  return (
    <Card 
        className="hitori-card-item puzzle-item"
        onClick={(event: React.MouseEvent<HTMLDivElement, MouseEvent>) => SetSelectedHitori(hitoriDetails)}
        style={{
...
export default connector(HitoriItemCard)